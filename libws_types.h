...
typedef void (*ws_msg_frame_begin_callback_f)(ws_t ws, ws_header_t *header, void *arg);
typedef void (*ws_msg_frame_data_callback_f)(ws_t ws, const char *payload, uint64_t len, void *arg);
